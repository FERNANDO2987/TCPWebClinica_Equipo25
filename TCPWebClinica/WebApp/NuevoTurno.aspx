...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                ...
                <div class="form-floating mb-3 search-container">
                    <div class="input-group input-group-custom">
                        ...
                        <div class="input-group-append">
                            ...
                            <asp:Button ID="btnNuevaBusqueda" runat="server" Text="Nueva Búsqueda" CssClass="btn btn-secondary ml-1" OnClientClick="activarBotonBuscar(); return false;" />
                        </div>
                    </div>
                </div>
    ...
    <script src="Script/mostrarPacientesSeleccionados.js"></script>
